...
<head>
    ...
    <meta name="interkassa-verification" content="8a3a538a7b1f506ae58b8a35cc383d92" />
    ...
    <link rel="stylesheet" href="{{ asset('/public/css/logout.css') }}">
    <script src="{{ asset('/public/js/app.js') }}" defer></script>
    <script src="{{ asset('/public/js/libs.min.js') }}" defer></script>
...
<header class="header">
    ...
    <div class="header__links">
        ...
        <ul class="header__links-ul">
            <li class="header__links-li"><a href="{{ url('/') }}">Про нас</a></li>
            <li class="header__links-li"><a href="{{ url('project') }}">Власні проекти</a></li>
            <li class="header__links-li"><a href="{{ url('gallery') }}">Галерея проектів</a></li>
        </ul>
        @if (Route::has('login'))
            <div class="top-right_links">
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a class = "registr" href="{{ route('register') }}">Регістрація</a>
                    @endif
                @endauth
            </div>
        @endif
        ...
        <div class="header__links-send">
            <a href = "#" ><svg width="40" height="30" viewBox="0 0 40 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="header__links-star">
            <a href = "#"><svg width="34" height="33" viewBox="0 0 34 33" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="main">
    ...
    <div class="info">
        ...
        <div class="info-arrow">
            <a href="#">
                <img src="/public/img/main-arrows.svg" alt="">
            </a>
        </div>
    ...
    <div class="in-account">
        ...
        <div class="main-title">
            ...
            <div class="main-image">
                <img src="/public/img/account-bg-2.png" alt="">
            </div>
        </div>

        <div class="account-img">
            <img src="/public/img/account-bg-1.png" alt="">
        </div>
    ...
    <div class="account">
        ...
        <div class="account__info-title">
            ...
            <img src="/public/img/account-bg-3.png" alt="">
        </div>
    ...
    <div class="in-galerry">
        <div class="galerry-title">
            ...
            <div class="galerry-title__image">
                <img src="/public/img/galerry-bg-2.png" alt="">
            </div>
        ...
        <div class="galerry-img">
            <img src="/public/img/galerry-bg-1.png" alt="">
        </div>
    </div>
    ...
    <div class="galerry">
        ...
        <div class="galerry__info-title">
            ...
            <img src="/public/img/galerry-bg-3.png" alt="">
        </div>
    ...
    <div class="in-service">
        ...
        <div class="service-img">
            <img src="/public/img/service-bg-1.png" alt="">
        </div>

        <div class="service-img-2">
            <img src="/public/img/service-bg-1-2.png" alt="">
        </div>
    ...
    <div class="service">
        ...
        <div class="service__info-title">
            ...
            <img src="/public/img/service-bg-3.png" alt="">
        </div>
...
<footer class="footer">
    ...
    <div class="footer__galerry">
        <a href="{{ url('gallery') }}"><div class="footer__ordering-text"><div class="footer__galerry-text">Галерея</div></div></a>
    ...
    <div class="footer__registration">
        <a href="{{ route('register') }}"><div class="footer__registration-text" style="text-decoration:none;">Реєстрація</div></a>
    ...
    <div class="footer__ordering">
        <a href="{{ url('gallery') }}"><div class="footer__ordering-text">Замовлення</div></a>
        <div class="footer__ordering-suptext">
            <div class="footer__ordering-suptext__item">Придбати готовий проект</div>
            <a href="{{ url('project') }}"><div class="footer__ordering-text"><div class="footer__ordering-suptext__item">Замовити новий</div></div></a>
